...
// Used the code provided with one simple modification for "&"
    ...
    public void map(Object _k, Text lines, Mapper.Context ctx) throws InterruptedException, IOException {
        ...
        try {
            ...
            if (flag) {
                ctx.getCounter("number", "numberofNodes").increment(1);
                ctx.write(new Text(pageName + " : "), new Text(finalstr));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
